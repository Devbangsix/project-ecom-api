...
-- AddForeignKey
ALTER TABLE `Cart` ADD CONSTRAINT `Cart_cartById_fkey` FOREIGN KEY (`cartById`) REFERENCES `User`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
